...
#   CCFF融合流程：
#   concat[3C] → Conv1x1(3C→C) → 三路分岔(Small+DCFM / Large+OKNetLargeKernel / Global(GMM∥FreqScale)) → Add → Residual
...
__all__ = ['HybridEncoderP2SPDOKMFS']
...
@register
class HybridEncoderP2SPDOKMFS(nn.Module):
    def __init__(self,
